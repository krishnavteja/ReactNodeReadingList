    ...
    var ReadingList = React.createClass({displayName: "ReadingList",
        ...
        render: function() {
            ...
            this.state.items.map(function(item, i) {
                      return (
                          React.createElement("div", {onClick: this.goToUrl.bind(this, item.url), key: i, className: "list-group-item"}, 
                              React.createElement("div", {className: "row"}, 
                                    React.createElement("div", {className: "col-md-11 col-sm-10 col-xs-9"}, 
                                    ...
                                    React.createElement("div", {className: "col-md-1 col-sm-2 col-xs-3"}, 
                                        React.createElement("a", {onClick: this.goToManagePage.bind(this, item._id), className: "btn btn-default btn-sm"}, "Edit")
                                    )
                            )
                        )
                      );
