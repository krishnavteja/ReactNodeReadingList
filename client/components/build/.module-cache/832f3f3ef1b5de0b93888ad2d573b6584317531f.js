        ...
        render: function() {
            ...
            return (
                ...
                React.createElement("div", {className: "row"}, 
				  ...
				  React.createElement("p", null, "Notes - ", item.description), 
				  React.createElement("p", null, "Tags - ", item.topic), 
				  React.createElement("p", null, "Priority - ", item.priority), 
				  React.createElement("p", null, "Complete - ", item.complete)
