        ...
        render: function() {
            return (React.createElement("div", {className: "container"}, 
                ...
                React.createElement("div", {className: "col-md-1 col-sm-2 col-xs-3"}, 
                    React.createElement("a", {href: "managereaditem.html", className: "btn btn-primary", style: {marginTop:'24px'}}, React.createElement("strong", null, "New"))
                )
            ), 
            ...
            this.state.items.map(function(item, i) {
                      return (
                          React.createElement("div", {onClick: this.goToUrl.bind(this, item.url), key: i, className: "list-group-item read-item-link"}, 
                              React.createElement("div", {className: "row"}, 
                                    React.createElement("div", {className: "col-md-11 col-sm-10 col-xs-9"}, 
