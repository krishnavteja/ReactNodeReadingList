(function () {
    ...
    var ManageReadItem = React.createClass({displayName: "ManageReadItem",
        ...
        getInitialState: function() {
            return {item: { url : 'www.google.com' }};
          },
        componentDidMount: function() {
            this.setInitialData();
          },
        doSomething: function(url, e) {
        ...
        render: function() {
            return (React.createElement("div", {className: "container"}, 
                React.createElement("div", {className: "row"}, 
				  ...
				  React.createElement("button", {onClick: this.doSomething.bind(this, this.state.item.url), className: "btn btn-default"}, "Submit")
