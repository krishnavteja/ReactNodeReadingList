(function () {
    ...
    //     	var xmlhttp = new XMLHttpRequest();
	   //          xmlhttp.open("POST","http://localhost:8888/api/newreaditem",true);
				// xmlhttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");
				// xmlhttp.send("url=" + this.state.item.url + "&description=" + this.state.item.description + "&topic=" + this.state.item.topic + 
            ...
            // $.post( "http://localhost:8888/api/newreaditem", postData, function() {
            //       alert( "success" );
            //     })
            //       .done(function(data) {
			...
			$.ajax({
			  type: "POST",
			  url: "http://localhost:8888/api/newreaditem",
			  data: postData,
			  success: function(result){
			        alert( "Data Saved: " + result.data );
			  },
                ...
                React.createElement("div", {className: "row"}, 
				  ...
				  React.createElement("div", {className: "checkbox"}, 
				    React.createElement("label", null, 
				      React.createElement("input", {type: "checkbox", checkLink: completeLink}), " Optional"
				    )
				  ), 
