    ...
    var ReadingList = React.createClass({displayName: "ReadingList",
        ...
        render: function() {
            ...
            this.state.items.map(function(item, i) {
                      return (
                          React.createElement("div", {key: i, className: "list-group-item"}, 
                              React.createElement("div", {className: "row"}, 
                                    React.createElement("div", {className: "col-md-10 col-sm-19 col-xs-8"}, 
                                    ...
                                    React.createElement("div", {className: "col-md-2 col-sm-3 col-xs-4"}, 
                                        React.createElement("div", {className: "btn-group"}, 
                                            React.createElement("button", {onClick: this.goToUrl.bind(this, item.url), 
                                                    className: "btn btn-success btn-sm"}, "Open"), 
